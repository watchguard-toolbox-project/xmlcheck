...
class WatchGuardService extends WatchGuardObject
{
    ...
    public function __construct(SimpleXMLElement $element) {
        ...
        $defaultServices = array(
            ...
            "WG-LogViewer-ReportMgr.15",
            "WG-LogViewer-ReportMgr.16",
            "WG-LogViewer-ReportMgr.17",
            "WG-LogViewer-ReportMgr.18",
            "WG-LogViewer-ReportMgr.19",
            "WG-LogViewer-ReportMgr.20",
            "WG-Mgmt-Server",
            "WG-SmallOffice-Mgmt",
            "WG-TDR-Host-Sensor",
            "WG-WebBlocker",
